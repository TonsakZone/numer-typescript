    ...
    return (
        <div className='root-main'>
            <div className='root-head'>
                <u><h4><b>Root of equations</b></h4></u>
            </div>
            <div className='root-child1'>
                <Card withBorder radius="md" className={classes.card}>
                    ...
                    <Group position="apart" mt="md">
                        <div>
                            <Text fw={700} fz="lg">Bisection</Text>
                            <Text fz="s" c="dimmed">
                                Root of equations method
                            </Text>
                        </div>
                        <Badge variant="gradient" gradient={{ from: 'orange', to: 'red' }}>Answer guaranteed</Badge>
                    </Group>
                ...
                <Card withBorder radius="md" className={classes.card}>
                    ...
                    <Group position="apart" mt="md">
                        <div>
                            <Text fw={700} fz="lg">False Position</Text>
                            <Text fz="s" c="dimmed">
                                Root of equations method
                            </Text>
                        </div>
                ...
                <Card withBorder radius="md" className={classes.card}>
                    ...
                    <Group position="apart" mt="md">
                        <div>
                            <Text fw={700} fz="lg">One-Point iteration</Text>
                            <Text fz="s" c="dimmed">
                                Root of equations method
                            </Text>
                        </div>
                        <Badge variant="gradient" gradient={{ from: 'gray', to: 'black' }}>Answer not guaranteed</Badge>
                    </Group>
            ...
            <div className='root-child2'>
                <Card withBorder radius="md" className={classes.card}>
                    ...
                    <Group position="apart" mt="md">
                        <div>
                            <Text fw={700} fz="lg">Newton-Raphson</Text>
                            <Text fz="s" c="dimmed">
                                Root of equations method
                            </Text>
                        </div>
                ...
                <Card withBorder radius="md" className={classes.card}>
                    ...
                    <Group position="apart" mt="md">
                        <div>
                            <Text fw={700} fz="lg">Taylor Series</Text>
                            <Text fz="s" c="dimmed">
                                Root of equations method
                            </Text>
                        </div>
